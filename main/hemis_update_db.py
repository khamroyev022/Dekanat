...
#         self.update_only = update_only  # True: faqat yangilaydi, False: yaratadi ham
...
#                 group_obj.save()
#
#             # Student yangilash (image ni o'zgartirmaymiz)
...
#             # image ni o'zgartirmaymiz ✅
#             student.save()
#
#         else:
#             # Import rejimi — yaratadi ham, yangilaydi ham
#             faculty_name = department.get("name", "").strip() or "Noma'lum fakultet"
#             faculty_code = department.get("code", "").strip() or "unknown"
#             faculty, _ = Faculty.objects.get_or_create(
#                 code=faculty_code,
...
#         )
#
#         return True, False  # updated=True, skipped=False
#
